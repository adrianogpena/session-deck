...
import { extractAssistantDisplayText, extractText, getClaudeProjectsDir, isDisplayableUserPrompt } from '@session-deck/core';
import { listCopilotTurns } from '@session-deck/core';
import { isInside } from '@session-deck/core';
